...
export default function ThemeToggle() {
  ...
  return (
    ...
    >
      ...
      {/* Sun Icon */}
      <div className={`absolute left-1 flex h-6 w-6 items-center justify-center rounded-full bg-white shadow-md transition-transform duration-300 ${
      ...
      <div className="absolute right-1 flex h-6 w-6 items-center justify-center">
        {theme === 'dark' ? (
